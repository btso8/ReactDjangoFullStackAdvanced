...
from api.models import Bet, Comment, Group, Event, Member, UserProfile
from api.serializers import BetSerializer, ChangePasswordSerializer, CommentSerializer, EventFullSerializer, GroupFullSerializer, GroupSerializer, EventSerializer, MemberSerializer, UserProfileSerializer, UserSerializer
